    ...
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg bg-opacity-10">
            <div class="container-fluid">
                <a class="navbar-brand" href="inicio.php">Listado de estudiantes</a>
        ...
        <div class="row justify-content-center mt-2 pt-2">
            ...
            <div class="alert alert-success d-none" id="mensajeExito">iNGRESADO</div>
            ...
            <div class="mb-3">
                ...
                <hr>
                <a class="btn btn-success" href="../registro_estudiante.php">Nuevo Estudiante
                    <i class="fa fa-plus"></i> </a>
                <a class="btn btn-warning" href="./_sesion/cerrarSesion.php">Log Out
            ...
            <table class="table_id">
                ...
                $SQL = "SELECT estudiantes.id, estudiantes.rut, estudiantes.nombre, estudiantes.carrera, estudiantes.cohorte, estudiantes.situacion_academica,
                        estudiantes.ingreso, estudiantes.cod_carrera FROM estudiantes";
            ...
            <div class="col text-center">
                ...
                <a class="btn btn-success" target="_blank" href="../pdf/pdf.php">Sacar Datos</a>

                <a class="btn btn-success" href="login.php">Volver</a>
            </div>
            <br>
